...
Route::middleware(['auth', 'verified',])->group(function () {
    Route::middleware(['role:Superadmin|Admin'])->group(function () {
        Route::name('admin.')->prefix('/admin')->group(function () {
            ...
            Route::name('data_penilaian.')->prefix('data-penilaian')->group(function () {
                Route::get('/index', [DataPenilaianController::class, 'index'])->name('index');
                Route::get('/json/{type}', [DataPenilaianController::class, 'data'])->name('data');
            });
        });
    });
    ...
    Route::name('public.')->prefix('/public')->group(function () {
        ...
        Route::name('about.')->prefix('about')->group(function () {
            ...
            Route::get('/json', [AboutController::class, 'data'])->name('data');
        });
    });
});
